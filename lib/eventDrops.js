    ...
    function eventDropGraph(selection) {
      selection.each(function (data) {
        ...
        function unload() {
          ...
          d3.select('.event-marker').on('mousemove', null);
        }
        ...
        function redraw(reset) {
          ...
          enter_and_update.append('g')
              ...
              .call(eventLine({ hasLabels: config.hasLabels, xScale: xScale, eventColor: config.eventColor, eventY: config.eventY, eventR: config.eventR, mousemove: mousemove }))
          ;
